                        ...
                        <div id="LayoutA" class="Layout">
                            ...
                            <div id="Left">
                            	<div id="opbox" class="dparts nineTable">
                                    <div class="parts">
		                                ...
		                                <c:when test="${item.author.id eq userId && fromcreated && item.relogItem==null}">
		                                   <button class="btn btn-primary" onclick="location.href='<c:url value="/item/${item.id}/edit"/>'">Return to edit</button>
		                                   <button class="btn btn-info" onclick="location.href='<c:url value="/item/${item.id}" />'" >Continue</button>
		                                </c:when>
		                                <c:otherwise>
                                ...
                                <div id="infobox" class="dparts nineTable">
									...
									<div class="navbar-primary"><h3 style="font-size: 14px; font-weight: bolder; line-height: 150%">Information</h3></div></div>
                                        <table>
                                            <tr>
                            ...
                            <div id="Center">
                                <div id="profile" class="dparts searchResultList">
									...
									<div class="navbar-primary">
                                            <h3 style="font-size: 14px; font-weight: bolder; line-height: 150%">Related Objects</h3>
                                        </div></div>
                                        <div class="block">
                                    ...
                                    <div class="parts">
                                       <div class="navbar navbar-inner" style="position: static;">
									<div class="navbar-primary">
                                            <h3 style="font-size: 14px; font-weight: bolder; line-height: 150%">Nearest Objects</h3>
                                        </div></div>
                                        <div class="block">
