		  	...
		  	<div class="login-form-wrap">
				  ...
				  <div class="row head-text">
					<div class="col-xs-12 col-md-12">
						<input type="username" name="username" value="${email}" class="form-control" id="email" placeholder="Username">
					</div>
				  </div>
				  	<!-- login form-->
				  <div class="row head-text">
				  ...
				  <div class="row head-text">
					<div class="col-xs-12 col-md-12">
						...
						<input type="button" class="btn btn-block" value="Sign in" onclick="signinAction()" style="background-color: rgb(41, 128, 185);color:white" />
					</div>
				  </div>
